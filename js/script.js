...
function addSearchBar(list) {
    ...
    searchBar.addEventListener('input', () => {
        ...
        //hide the first pagination button if there's only one page
        const paginationButtons = document.querySelectorAll('.link-list li');
        if (paginationButtons.length === 1) {
            paginationButtons[0].classList.add('hide');
        }
    });
}
